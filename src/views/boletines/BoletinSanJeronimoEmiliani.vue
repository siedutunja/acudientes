...
export default {
  ...
  computed: {
    ...
    // San Jeronimo Emiliani pondera cada periodo distinto (ej. 20/20/30/30) en vez de parejo -
    // el promedio se calcula como suma(nota * peso/100), igual que en academico.
    pesosPeriodos () {
      const c = this.config
