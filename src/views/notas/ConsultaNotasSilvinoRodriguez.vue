...
import BoletinAcudiente from '@/views/boletines/BoletinSilvinoRodriguez'
import BoletinPree from '@/views/boletines/BoletinPree'

const ID_SILVINO_RODRIGUEZ = 'c50f3d80-fca0-11ec-8267-536b07c743c4'
const OPCION_ACUMULADO = 'ACUMULADO'

export default {
  name: 'ConsultaNotasSilvinoRodriguez',
  ...
  data () {
    return {
      ...
      rangoAcumulado: '1-4',
      filtroArea: '',
      nombreInstitucionFallback: 'INSTITUCIÓN EDUCATIVA SILVINO RODRIGUEZ',
      escudoInstitucion: ''
    }
  },
  computed: {
    ...
    async cargarConfig () {
      try {
        const resp = await axios.get(CONFIG.ROOT_PATH + 'acudientes/config-evaluacion', {
          params: { idInstitucion: ID_SILVINO_RODRIGUEZ, vigencia: this.vigencia }
        })
