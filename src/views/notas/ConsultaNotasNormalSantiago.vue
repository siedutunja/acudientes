...
import BoletinAcudiente from '@/views/boletines/BoletinNormalSantiago'
import BoletinPree from '@/views/boletines/BoletinPree'

const ID_NORMAL = '7c63ed50-fcb0-11ec-8267-536b07c743c4'
const OPCION_ACUMULADO = 'ACUMULADO'

export default {
  name: 'ConsultaNotasNormalSantiago',
  ...
  data () {
    return {
      ...
      rangoAcumulado: '1-4',
      filtroArea: '',
      nombreInstitucionFallback: 'ESCUELA NORMAL SUPERIOR SANTIAGO DE TUNJA',
      escudoInstitucion: ''
    }
  },
  computed: {
    ...
    async cargarConfig () {
      try {
        const resp = await axios.get(CONFIG.ROOT_PATH + 'acudientes/config-evaluacion', {
          params: { idInstitucion: ID_NORMAL, vigencia: this.vigencia }
        })
